...
namespace LeopotamGroup.Serialization
{
    ...
    public sealed class XmlNode
    {
        ...
        private readonly List<XmlAttribute> _attributes = new List<XmlAttribute>(4);

        private static readonly FastList<XmlNode> _pool = new FastList<XmlNode>(128);
        ...
        private void Init(string xmlSource, ref int i, bool useHashesForNames)
        {
