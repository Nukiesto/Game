...
namespace LeopotamGroup.Scripting.Internal
{
    internal class Parser
    {
        ...
        private const int _minErrDist = 2;
        ...
        private int errDist = _minErrDist;
        ...
        private readonly List<string> _paramList = new List<string>(8);
        ...
        private void Expr(out ScriptVar v)
        {
            ScriptVar b; int op;
            Expr1(out v);
        ...
        private void Expr1(out ScriptVar v)
        {
            ScriptVar b; int op;
            Expr2(out v);
        ...
        private void Expr2(out ScriptVar v)
        {
        ...
        private void Expr3(out ScriptVar v)
        {
        ...
        private void Expr4(out ScriptVar v)
        {
            ScriptVar b;
            Expr5(out v);
        ...
        private void Expr5(out ScriptVar v)
        {
        ...
        private void Term(out ScriptVar v)
        {
    ...
    {
        private const string ErrFormat = "-- line {0} col {1}: {2}"; // 0=line, 1=column, 2=text
