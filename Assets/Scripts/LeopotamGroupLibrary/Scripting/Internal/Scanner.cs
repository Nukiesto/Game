...
namespace LeopotamGroup.Scripting.Internal
{
    ...
    internal class Scanner
    {
        ...
        private const int maxT = 31;
        private const int noSym = 31;

        public static readonly Token EmptyToken = new Token { kind = 0, val = "" };

        private readonly List<Token> _tokens = new List<Token>(512);
        public int PC;
        ...
        private readonly Buffer buffer = new Buffer(); // scanner buffer
