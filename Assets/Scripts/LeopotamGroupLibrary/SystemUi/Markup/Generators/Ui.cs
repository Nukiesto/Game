...
{
    internal static class UiNode
    {
        private static readonly int HashedBase = "base".GetStableHashCode();

        private static readonly int HashedDragTreshold = "dragTreshold".GetStableHashCode();
