...
namespace LeopotamGroup.SystemUi.Markup.Generators
{
    ...
    {
        private static readonly int HashedFontName = "fontName".GetStableHashCode();

        private static readonly int HashedFontSize = "fontSize".GetStableHashCode();

        private static readonly int HashedFontStyle = "fontStyle".GetStableHashCode();

        private static readonly int HashedAlign = "align".GetStableHashCode();

        private static readonly int HashedLocalize = "localize".GetStableHashCode();
