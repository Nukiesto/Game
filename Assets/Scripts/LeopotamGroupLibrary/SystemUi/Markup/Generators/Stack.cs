...
namespace LeopotamGroup.SystemUi.Markup.Generators
{
    ...
    {
        private static readonly int HashedPadding = "padding".GetStableHashCode();

        private static readonly int HashedAlign = "align".GetStableHashCode();

        private static readonly int HashedVertical = "vertical".GetStableHashCode();

        private static readonly int HashedReverse = "reverse".GetStableHashCode();
