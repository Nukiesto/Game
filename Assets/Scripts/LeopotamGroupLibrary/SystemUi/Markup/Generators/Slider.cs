...
{
    internal static class SliderNode
    {
        private static readonly int HashedHandle = "handle".GetStableHashCode();

        private static readonly int HashedRtl = "rtl".GetStableHashCode();

        private static readonly int HashedRange = "range".GetStableHashCode();

        private static readonly int HashedValue = "value".GetStableHashCode();
