...
{
    internal static class FixedTableNode
    {
        private static readonly int HashedItemsInRow = "itemsInRow".GetStableHashCode();

        private static readonly int HashedCellSize = "cellSize".GetStableHashCode();
