...
{
    internal static class ToggleNode
    {
        ...
        private static readonly int HashedGroup = "group".GetStableHashCode();

        private static readonly int HashedCheck = "check".GetStableHashCode();
