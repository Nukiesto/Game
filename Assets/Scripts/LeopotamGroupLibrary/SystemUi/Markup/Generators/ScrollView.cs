...
{
    internal static class ScrollViewNode
    {
        public const string ViewportName = "viewport";

        public const string ContentName = "content";

        private static readonly int HashedContentSize = "contentSize".GetStableHashCode();

        private static readonly int HashedBar = "bar".GetStableHashCode();

        private static readonly int HashedDrag = "drag".GetStableHashCode();

        private static readonly int HashedClamp = "clamp".GetStableHashCode();

        private static readonly int HashedOnChange = "onChange".GetStableHashCode();
        ...
        private static Scrollbar CreateScrollbar(RectTransform widget, MarkupTheme theme, bool isHorizontal)
        {
            Image img;
