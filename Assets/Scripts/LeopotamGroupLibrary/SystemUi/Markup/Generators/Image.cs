...
namespace LeopotamGroup.SystemUi.Markup.Generators
{
    ...
    {
        private static readonly int HashedPath = "path".GetStableHashCode();

        private static readonly int HashedRaw = "raw".GetStableHashCode();

        private static readonly int HashedNativeSize = "nativeSize".GetStableHashCode();

        private static readonly int HashedMask = "mask".GetStableHashCode();

        private static readonly int HashedFillCenter = "fillCenter".GetStableHashCode();
