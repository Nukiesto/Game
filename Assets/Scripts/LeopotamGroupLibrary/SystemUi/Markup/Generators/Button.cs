...
{
    internal static class ButtonNode
    {
        private static readonly int HashedBlend = "blend".GetStableHashCode();

        private static readonly int HashedDisabled = "disabled".GetStableHashCode();
