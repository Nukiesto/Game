...
namespace LeopotamGroup.SystemUi.Markup
{
    ...
    public class MarkupContainer : MonoBehaviour
    {
        ...
        [SerializeField]
        private string _markupPath = "UnknownMarkup";
        ...
        [SerializeField]
        private List<MarkupTheme> _themes = new List<MarkupTheme>();

        private XmlNode _xmlTree;
        ...
        private readonly Dictionary<int, RectTransform> _namedNodes = new Dictionary<int, RectTransform>(128);

        private Font _defaultFont;

        private MarkupTheme _defaultTheme;

        private bool _areGeneratorsAttached;
        ...
        private static XmlNode LoadXml(string markupPath)
        {
        ...
        private void CreateVisualNode(XmlNode xmlTree, RectTransform root)
        {
            if (xmlTree == null)
            {
                return;
