...
namespace LeopotamGroup.SystemUi.DataBinding
{
    ...
    {
        private readonly FastList<BindedSourceInfo> _sourcesList = new FastList<BindedSourceInfo>(128);

        private BindedSourceInfo[] _sourcesData;
        ...
        private void OnDataChanged(IDataSource source, string property)
        {
        ...
        private BindedSourceInfo GetSource(string sourceName, bool createNew = false)
        {
            for (var i = _sourcesCount - 1; i >= 0; i--)
            {
        ...
        private class BindedSourceInfo
        {
        ...
        private class BindedPropertyInfo
        {
