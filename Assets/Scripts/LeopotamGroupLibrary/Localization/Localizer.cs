...
{
    /// <summary>
    /// Локализатор - помощник при локализации. Поддерживает динамическое переопределение токенов локализации с откатом.
    /// </summary>
    public static class Localizer
    {
        ...
        private const string HeaderToken = "KEY";

        private const string DefaultStaticSourcePath = "Localization";

        private const string DefaultLanguage = "English";

        private const string SettingsKey = "lg.locale";

        private const string OnLocalizeMethodName = "OnLocalize";

        private static readonly Dictionary<string, string[]> _statics = new Dictionary<string, string[]>(64);

        private static readonly Dictionary<string, string[]> _dynamics = new Dictionary<string, string[]>(64);
        ...
        private static void LoadData(string data, Dictionary<string, string[]> storage)
        {
