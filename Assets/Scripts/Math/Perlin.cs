...
public static class Perlin
{
    ...
    //Диапазон значений шумовых функций равен [-1.0, +1.0].
    //AFAIK, диапазон значений функций fBm не вполне определен.Может быть и так где-то около[-0, 75, +0, 75]. Пожалуйста дайте мне знать если у вас есть точная информация решение
    //1D
