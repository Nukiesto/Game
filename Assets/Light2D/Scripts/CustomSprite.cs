...
namespace Light2D
{
    ...
    public class CustomSprite : MonoBehaviour
    {
        ...
        protected virtual void UpdateSprite()// Recreating mesh data for Sprite based on it's bounds.
        {
            if (Sprite == null)
                return;
        ...
        public class MaterialValue// Used as a value to material map to support reference counting.
        {
            public Material Material;// Instantiated material from MaterialKey.Material with texture from MaterialKey.Texture.

            public int UsageCount;// Count of CustomSprites using that material.
        ...
        public class MaterialKey : IEquatable<MaterialKey>// Used as a key to material map.
        {
            /// <summary>
            /// Sprite's texture.
            /// </summary>
            public Texture2D Texture;
            public Material Material;//Non instantiated material.
